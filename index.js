...
decx.on('messageCreate', async (msg) => {
	...
	const embed = new discord.EmbedBuilder()
		.setColor('#2f3136')
		.setImage('https://cdn.discordapp.com/attachments/1089056828014469181/1139540651390795847/VItale.gif')
		.setAuthor({ name: 'Criar ticket de atendimento | Vitale', iconURL: 'https://cdn.discordapp.com/attachments/1089056828014469181/1139966779972661390/Vitale_City.gif', url: 'https://discord.com/invite/dX5RtYepjp' })
		.setURL('https://discord.com/invite/dX5RtYepjp')
		.setDescription('Para dúvidas e suporte do ilegal.')
		.setFooter({ text: 'Vitale © 2023', iconURL: 'https://cdn.discordapp.com/attachments/1089056828014469181/1139966779972661390/Vitale_City.gif' });
...
decx.on('interactionCreate', async interaction => {
	...
	if (interaction.customId === 'delete') {
		...
		const deleteMessage = new discord.EmbedBuilder()
			...
			.setColor('#2f3136')
			.setFooter({ text: 'Vitale © 2023', iconURL: 'https://cdn.discordapp.com/attachments/929573302098362399/999093804034445442/Logo_4.png' });
...
decx.login("MTEzOTkyNzA3ODQwMjI4MTUxMg.GLF0Fe.XdLeYJh-5CqD-mufCx3UncsCIj2q2xY8Nx_ABU");
